...
| Mermaid Freak is the massive final boss, not the ordinary grunt replacement. | The opt-in encounter creates one `TethysBoss`; ordinary and guardian encounters use the separately delivered Angler and Swordfish actors. | **Done** |
