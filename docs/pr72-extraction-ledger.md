...
| 3 — Menus/spells/title | [PR #81](https://github.com/Mhanna112-code/UnderwaterGame/pull/81) | `90c1853` | `menus_spell_title` (Help scroll/replay, live title-route composition, Potion UI, legal spell learning), `persistence` (save/reload inventory/world rewards) — green | Final exact-head rerun pending after evidence commit | Captures show query-gated title action and actual Learn Spells tree; browser route follows Save → Update → Learn | Final immutable preview pending | In verification |
