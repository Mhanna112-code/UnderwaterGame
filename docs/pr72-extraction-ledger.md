...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 — Tutorial presentation | pending | `5069ed5` | pending | pending | pending | pending | Planned |
| 2 — Combat Quick Read | pending | pending | pending | pending | pending | pending | Planned |
